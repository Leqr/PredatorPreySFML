 ...
 */
 ...
 protected:
      ...
      */
     void render(sf::Drawable const& simulationBackground, sf::Drawable const& statsBackground, sf::Drawable const& infoBackground);
     ...
     /*!
      * @brief Draw information about the keys used in the program on the info panel
      */
      void drawOnInfoPanel(sf::RenderTarget& target);

     /*!
      * @brief Build an sf::Text where position is the positio of the first character
      * Is not working like Utility/Utility buildText function.
      */
     sf::Text buildText(std::string const& msg, Vec2d const& position, sf::Font const& font, unsigned int size, sf::Color color);

     /*!
      * @brief Draw a grey border between the stat and the info panel.
      */
 ...
 //    j::Value          mJSONRead;       ///< Application configuration
     ...
     sf::View mInfoView;             //Create a window where info can be drawn.

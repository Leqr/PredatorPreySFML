...
, window_info_width(mConfig["window"]["info"]["width"].toDouble())
...
, stats_upscaling_ratio(mConfig["stats"]["upscaling ratio"].toDouble())
, window_stats_height(mConfig["stats"]["height"].toDouble())
...
// plant
//, plant_size(mConfig["simulation"]["plant"]["size"].toDouble())
, plant_initial_energy(mConfig["simulation"]["plant"]["energy"]["initial"].toDouble())
, plant_max_energy(mConfig["simulation"]["plant"]["energy"]["max"].toDouble())
, plant_growth_factor(mConfig["simulation"]["plant"]["energy"]["growth factor"].toDouble())
, plant_reproduction(mConfig["simulation"]["plant"]["reproduction"].toBool())
...
, animal_deceleration(mConfig["simulation"]["animal"]["dynamics"]["deceleration"].toDouble())
, animal_escape_coeff1(mConfig["simulation"]["animal"]["dynamics"]["escape coeff 1"].toDouble())
, animal_escape_coeff2(mConfig["simulation"]["animal"]["dynamics"]["escape coeff 2"].toDouble())
, animal_delivery_time(mConfig["simulation"]["animal"]["reproduction"]["delivery time"].toDouble())
, animal_avoidance_coeff(mConfig["simulation"]["animal"]["dynamics"]["avoidance coeff"].toDouble())
, animal_avoidance_threshold(mConfig["simulation"]["animal"]["dynamics"]["avoidance threshold"].toDouble())
...
, sheep_debug_state_position_y(mConfig["simulation"]["animal"]["sheep"]["debug view"]["statePositiony"].toDouble())
, sheep_debug_state_position_x(mConfig["simulation"]["animal"]["sheep"]["debug view"]["statePositionx"].toDouble())
, sheep_debug_sex_position_y(mConfig["simulation"]["animal"]["sheep"]["debug view"]["sexPositiony"].toDouble())
, sheep_debug_sex_position_x(mConfig["simulation"]["animal"]["sheep"]["debug view"]["sexPositionx"].toDouble())
, sheep_debug_energy_position_y(mConfig["simulation"]["animal"]["sheep"]["debug view"]["energyPositiony"].toDouble())
, sheep_debug_energy_position_x(mConfig["simulation"]["animal"]["sheep"]["debug view"]["energyPositionx"].toDouble())
...
, sheep_adult_size(mConfig["simulation"]["animal"]["sheep"]["adult size"].toDouble())
...
, wolf_debug_state_position_y(mConfig["simulation"]["animal"]["wolf"]["debug view"]["statePositiony"].toDouble())
, wolf_debug_state_position_x(mConfig["simulation"]["animal"]["wolf"]["debug view"]["statePositionx"].toDouble())
, wolf_debug_sex_position_y(mConfig["simulation"]["animal"]["wolf"]["debug view"]["sexPositiony"].toDouble())
, wolf_debug_sex_position_x(mConfig["simulation"]["animal"]["wolf"]["debug view"]["sexPositionx"].toDouble())
, wolf_debug_energy_position_y(mConfig["simulation"]["animal"]["wolf"]["debug view"]["energyPositiony"].toDouble())
, wolf_debug_energy_position_x(mConfig["simulation"]["animal"]["wolf"]["debug view"]["energyPositionx"].toDouble())
...
, wolf_adult_size(mConfig["simulation"]["animal"]["wolf"]["adult size"].toDouble())
